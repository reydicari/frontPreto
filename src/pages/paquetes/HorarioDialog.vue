  ...
  <q-dialog v-model="isOpen" persistent>
    <q-card style="min-width: 400px; max-width: 500px;">
      ...
      <q-card-actions align="right">
        <q-btn v-if="isEditing && canRemove" flat label="Eliminar" color="negative" icon="delete" @click="remove" />
        <q-btn flat label="Cancelar" color="grey-7" v-close-popup />
        <q-btn unelevated :label="isEditing ? 'Actualizar' : 'Guardar'" color="green-7" icon="save" @click="save" />
      </q-card-actions>
    </q-card>
  </q-dialog>
</template>
