...
onMounted(async () => {
  ...
  // construir lista única de niveles a partir de inscripciones (enviar objetos con id/nombre_nivel)
  const niveles = []
  const seen = new Set()
