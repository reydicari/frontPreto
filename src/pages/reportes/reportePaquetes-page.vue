  ...
  <q-page class="q-pa-md" :class="$q.dark.isActive ? '' : 'bg-grey-4'">
    <div class="row items-center justify-between q-mb-md">
      ...
      <div class="row q-gutter-sm">
        ...
        <q-btn color="positive" icon="file_download" label="Excel" @click="generarReporteGeneralExcel" />
      </div>
    </div>
    ...
    <q-card class="q-mb-md">
      <q-card-section>
        <div class="row q-col-gutter-md">
          <!-- Búsqueda general -->
          <q-input v-model="filters.search" outlined dense clearable placeholder="Buscar por nombre de paquete..."
          ...
          <q-select v-model="filters.disciplina" :options="disciplinaOptions" option-label="nombre" option-value="id"
            label="Disciplina" outlined dense clearable emit-value map-options class="col-6 col-md-3" />
          ...
          <q-select v-model="filters.materiales" :options="booleanOptions" label="Materiales incluidos" outlined dense
            clearable emit-value map-options class="col-6 col-md-3" />

          <!-- Rango de mensualidad -->
          <q-input v-model.number="filters.mensualidadMin" type="number" outlined dense label="Mensualidad mínima (Bs)"
            class="col-6 col-md-2" :min="0" prefix="Bs" />

          <q-input v-model.number="filters.mensualidadMax" type="number" outlined dense label="Mensualidad máxima (Bs)"
            class="col-6 col-md-2" :min="0" prefix="Bs" />
          ...
          <div class="col-6 col-md-3">
            <q-input dense outlined v-model="filters.fechaInicio" label="Fecha inicio desde" readonly clearable>
              <template v-slot:append>
      ...
      <q-table :rows="filteredPaquetes" :columns="columns" row-key="id" :loading="loading" :pagination="pagination"
        ...
        <template v-slot:body-cell-horarios="props">
          <q-td :props="props">
            ...
            <div v-if="props.row.horarios && props.row.horarios.length > 0" class="q-mt-xs text-caption text-grey-7">
