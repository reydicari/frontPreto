    ...
    <q-card class="filter-card q-mb-md">
      ...
      <q-card-section>
        <div class="row q-col-gutter-md">
          ...
          <!-- Categoría -->
          <q-select v-model="filters.categoria" :options="categoriaOptions" option-label="nombre" option-value="id"
            label="Categoría" outlined dense clearable emit-value map-options class="col-6 col-md-3" />
          ...
          <!-- Con comprobante -->
          <q-select v-model="filters.conComprobante" :options="comprobanteOptions" label="Comprobante" outlined dense
