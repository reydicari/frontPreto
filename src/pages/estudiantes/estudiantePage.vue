<template>
  <q-page class="q-pa-md" :class="$q.dark.isActive ? '' : 'bg-grey-4'">
    <div class="q-mb-md">
      <h2 class="text-h4 q-ma-none page-title">Gestión de Estudiantes</h2>
    </div>
    ...
    <q-card class="q-mb-md">
      <q-card-section>
        <div class="row items-center justify-between">
          ...
          <q-btn color="primary" icon="add" label="Agregar Estudiante" @click="showPersonaDialog" />
        ...
        <div v-for="(persona, index) in filteredPersonas" :key="persona.id"
          ...
          <q-card class="my-card" height="100px">
              ...
              <div class="row items-start">
                ...
                <div class="col-8 q-pl-md">
                  ...
                  <div class="text-caption">
                    ...
                    <div><strong>Categoría:</strong> {{ persona.categoria || '' }}</div>
            ...
            <q-card-actions align="around">
              ...
              <q-btn icon="visibility" color="info" flat dense @click="verPagosPersona(persona)" />
            </q-card-actions>
          </q-card>
        </div>
