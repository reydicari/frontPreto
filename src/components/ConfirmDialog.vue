  ...
  <q-dialog v-model="modelLocal" persistent>
    <q-card class="confirm-dialog-card" style="min-width:320px; max-width:600px;">
      ...
      <q-card-actions align="right" class="confirm-actions">
        ...
        <q-btn unelevated :label="confirmLabel" :color="danger ? 'negative' : 'primary'" text-color="white" @click="onConfirm" />
      </q-card-actions>
    </q-card>
  </q-dialog>
</template>
...
.confirm-body { padding: 18px; background: white; }
.confirm-actions { padding: 12px 16px; background: #f6f6f6; }
</style>